describe('form tests', () => {
    ...
    it('Test subscribe form', () => {
        ...
        cy.get('@subscribe-input').type('ryan@coderyan.gov')
        cy.contains(/invalid email: ryan@coderyan.gov!/i).should('not.exist')
        cy.getDataTest('subscribe-button').click()
        cy.contains(/invalid email: ryan@coderyan.gov!/i).should('exist')
        cy.wait(3000)
        cy.contains(/invalid email: ryan@coderyan.gov!/i).should('not.exist')
